...
const NUMERIC_FIELDS: Record<string, string[]> = {
  ...
  customers: ['points'],
  expenses: ['amount'],
  settings: ['tax_percent', 'shipping_fee', 'loyalty_earn_egp', 'loyalty_point_value', 'loyalty_min_redeem'],
  journal_lines: ['debit', 'credit'],
  orders: ['subtotal', 'discount', 'shipping', 'total', 'coupon_discount', 'points_used'],
